...
import { MongojhipsterTestModule } from '../../../test.module';
    ...
    describe('Task Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [MongojhipsterTestModule],
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Task('aaa')));
            ...
            expect(comp.task).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
